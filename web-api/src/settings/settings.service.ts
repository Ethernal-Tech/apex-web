...
export class SettingsService {
	...
	async init() {
		...
		allowedDirections[ChainEnum.Solana] = [ChainEnum.Cardano]; // TODO: Hack for hackaton
		allowedDirections[ChainEnum.Cardano].push(ChainEnum.Solana); // TODO: Hack for hackaton
