...
export class TransactionControllerClient extends BaseClient {
     ...
     * @return Success
     */
    createEth(body: CreateTransactionDto): Promise<CreateEthTransactionFullResponseDto> {
    ...
    protected processCreateEth(response: Response): Promise<CreateEthTransactionFullResponseDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CreateEthTransactionFullResponseDto.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
...
export class LockedTokensControllerClient extends BaseClient {
     ...
     */
    getTransferredSum(startDate: string, endDate: string, groupBy: GroupBy | undefined, allowedBridgingModes: BridgingModeEnum[] | undefined): Promise<TransferredTokensByDay> {
    ...
    protected processGetTransferredSum(response: Response): Promise<TransferredTokensByDay> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TransferredTokensByDay.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<TransferredTokensByDay>(null as any);
    }
}

export class BridgingSettingsTokenPairDto implements IBridgingSettingsTokenPairDto {
    /** Source Token ID */
    srcTokenID!: number;
    ...
    constructor(data?: IBridgingSettingsTokenPairDto) {
        if (data) {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.srcTokenID = _data["srcTokenID"];
            this.dstTokenID = _data["dstTokenID"];
        }
    }

    static fromJS(data: any): BridgingSettingsTokenPairDto {
        data = typeof data === 'object' ? data : {};
        let result = new BridgingSettingsTokenPairDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["srcTokenID"] = this.srcTokenID;
        data["dstTokenID"] = this.dstTokenID;
        return data;
    }
}

export interface IBridgingSettingsTokenPairDto {
    /** Source Token ID */
    srcTokenID: number;
    /** Destination Token ID */
    dstTokenID: number;
...
export class BridgingSettingsTokenDto implements IBridgingSettingsTokenDto {
    /** For Cardano policyID.name. For eth, its the erc20 contract address */
    chainSpecific!: string;
    /** Specifies the mechanism of bridge handling of this token */
    lockUnlock!: boolean;
    /** Specifies if this token is a wrapped currency */
    isWrappedCurrency!: boolean;

    [key: string]: any;

    constructor(data?: IBridgingSettingsTokenDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.chainSpecific = _data["chainSpecific"];
            this.lockUnlock = _data["lockUnlock"];
            this.isWrappedCurrency = _data["isWrappedCurrency"];
        }
    }

    static fromJS(data: any): BridgingSettingsTokenDto {
        data = typeof data === 'object' ? data : {};
        let result = new BridgingSettingsTokenDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["chainSpecific"] = this.chainSpecific;
        data["lockUnlock"] = this.lockUnlock;
        data["isWrappedCurrency"] = this.isWrappedCurrency;
        return data;
    }
}

export interface IBridgingSettingsTokenDto {
    /** For Cardano policyID.name. For eth, its the erc20 contract address */
    chainSpecific: string;
    /** Specifies the mechanism of bridge handling of this token */
    lockUnlock: boolean;
...
export class BridgingSettingsDirectionConfigDto implements IBridgingSettingsDirectionConfigDto {
    /** Token pairs */
    destChain!: { [key: string]: BridgingSettingsTokenPairDto[]; };
    /** For each tokenID (key), the definition of the token */
    tokens!: { [key: string]: BridgingSettingsTokenDto; };

    [key: string]: any;

    constructor(data?: IBridgingSettingsDirectionConfigDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (_data["destChain"]) {
                this.destChain = {} as any;
                for (let key in _data["destChain"]) {
                    if (_data["destChain"].hasOwnProperty(key))
                        (this.destChain as any)![key] = _data["destChain"][key] ? _data["destChain"][key].map((i: any) => BridgingSettingsTokenPairDto.fromJS(i)) : [];
                }
            }
            if (_data["tokens"]) {
                this.tokens = {} as any;
                for (let key in _data["tokens"]) {
                    if (_data["tokens"].hasOwnProperty(key))
                        (this.tokens as any)![key] = _data["tokens"][key] ? BridgingSettingsTokenDto.fromJS(_data["tokens"][key]) : new BridgingSettingsTokenDto();
                }
            }
        }
    }

    static fromJS(data: any): BridgingSettingsDirectionConfigDto {
        data = typeof data === 'object' ? data : {};
        let result = new BridgingSettingsDirectionConfigDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        if (this.destChain) {
            data["destChain"] = {};
            for (let key in this.destChain) {
                if (this.destChain.hasOwnProperty(key))
                    (data["destChain"] as any)[key] = (this.destChain as any)[key];
            }
        }
        if (this.tokens) {
            data["tokens"] = {};
            for (let key in this.tokens) {
                if (this.tokens.hasOwnProperty(key))
                    (data["tokens"] as any)[key] = this.tokens[key] ? this.tokens[key].toJSON() : undefined as any;
            }
        }
        return data;
    }
...
export interface IBridgingSettingsDirectionConfigDto {
    /** Token pairs */
    destChain: { [key: string]: BridgingSettingsTokenPairDto[]; };
    /** For each tokenID (key), the definition of the token */
    tokens: { [key: string]: BridgingSettingsTokenDto; };
...
export class BridgingSettingsEcosystemTokenDto implements IBridgingSettingsEcosystemTokenDto {
    /** ID of the token */
    id!: number;
    /** Name of the token */
    name!: string;
    ...
    constructor(data?: IBridgingSettingsEcosystemTokenDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): BridgingSettingsEcosystemTokenDto {
        data = typeof data === 'object' ? data : {};
        let result = new BridgingSettingsEcosystemTokenDto();
        result.init(data);
        return result;
    }
...
export interface IBridgingSettingsEcosystemTokenDto {
    /** ID of the token */
    id: number;
    /** Name of the token */
    name: string;
...
export class BridgingSettingsDto implements IBridgingSettingsDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (_data["minChainFeeForBridgingTokens"]) {
                this.minChainFeeForBridgingTokens = {} as any;
                for (let key in _data["minChainFeeForBridgingTokens"]) {
                    if (_data["minChainFeeForBridgingTokens"].hasOwnProperty(key))
                        (this.minChainFeeForBridgingTokens as any)![key] = _data["minChainFeeForBridgingTokens"][key];
                }
            }
            ...
            if (_data["directionConfig"]) {
                ...
                for (let key in _data["directionConfig"]) {
                    if (_data["directionConfig"].hasOwnProperty(key))
                        (this.directionConfig as any)![key] = _data["directionConfig"][key] ? BridgingSettingsDirectionConfigDto.fromJS(_data["directionConfig"][key]) : new BridgingSettingsDirectionConfigDto();
                }
            }
            if (Array.isArray(_data["ecosystemTokens"])) {
                this.ecosystemTokens = [] as any;
                for (let item of _data["ecosystemTokens"])
                    this.ecosystemTokens!.push(BridgingSettingsEcosystemTokenDto.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (this.minChainFeeForBridgingTokens) {
            data["minChainFeeForBridgingTokens"] = {};
            for (let key in this.minChainFeeForBridgingTokens) {
                if (this.minChainFeeForBridgingTokens.hasOwnProperty(key))
                    (data["minChainFeeForBridgingTokens"] as any)[key] = (this.minChainFeeForBridgingTokens as any)[key];
            }
        }
        ...
        if (this.directionConfig) {
            ...
            for (let key in this.directionConfig) {
                if (this.directionConfig.hasOwnProperty(key))
                    (data["directionConfig"] as any)[key] = this.directionConfig[key] ? this.directionConfig[key].toJSON() : undefined as any;
            }
        }
        if (Array.isArray(this.ecosystemTokens)) {
            data["ecosystemTokens"] = [];
            for (let item of this.ecosystemTokens)
                data["ecosystemTokens"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
...
export class CreateCardanoTransactionResponseTokenAmountDto implements ICreateCardanoTransactionResponseTokenAmountDto {
    /** ID of the token */
    tokenID!: number;
    /** amount of the token */
    amount!: string;
    ...
    constructor(data?: ICreateCardanoTransactionResponseTokenAmountDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): CreateCardanoTransactionResponseTokenAmountDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateCardanoTransactionResponseTokenAmountDto();
        result.init(data);
        return result;
    }
...
export interface ICreateCardanoTransactionResponseTokenAmountDto {
    /** ID of the token */
    tokenID: number;
    /** amount of the token */
    amount: string;
...
export class CreateCardanoTransactionResponseDto implements ICreateCardanoTransactionResponseDto {
    ...
    nativeTokenAmount?: CreateCardanoTransactionResponseTokenAmountDto[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["nativeTokenAmount"])) {
                ...
                for (let item of _data["nativeTokenAmount"])
                    this.nativeTokenAmount!.push(CreateCardanoTransactionResponseTokenAmountDto.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.nativeTokenAmount)) {
            ...
            for (let item of this.nativeTokenAmount)
                data["nativeTokenAmount"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
...
export class EthTransactionResponseDto implements IEthTransactionResponseDto {
    from!: string;
    to!: string;
    ...
    constructor(data?: IEthTransactionResponseDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): EthTransactionResponseDto {
        data = typeof data === 'object' ? data : {};
        let result = new EthTransactionResponseDto();
        result.init(data);
        return result;
    }
...
export interface IEthTransactionResponseDto {
    from: string;
    to: string;
    value?: string | undefined;
    data: string;
...
export class BridgingEthTransactionResponseDto implements IBridgingEthTransactionResponseDto {
    /** Eth tx to be executed */
    ...
    constructor(data?: IBridgingEthTransactionResponseDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
        ...
        if (!data) {
            this.ethTx = new EthTransactionResponseDto();
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.ethTx = _data["ethTx"] ? EthTransactionResponseDto.fromJS(_data["ethTx"]) : new EthTransactionResponseDto();
            this.bridgingFee = _data["bridgingFee"];
            this.operationFee = _data["operationFee"];
    ...
    static fromJS(data: any): BridgingEthTransactionResponseDto {
        data = typeof data === 'object' ? data : {};
        let result = new BridgingEthTransactionResponseDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["ethTx"] = this.ethTx ? this.ethTx.toJSON() : undefined as any;
        data["bridgingFee"] = this.bridgingFee;
        data["operationFee"] = this.operationFee;
...
export interface IBridgingEthTransactionResponseDto {
    /** Eth tx to be executed */
    ethTx: EthTransactionResponseDto;
    bridgingFee: string;
    operationFee: string;
...
export class CreateEthTransactionFullResponseDto implements ICreateEthTransactionFullResponseDto {
    /** Approval tx for the bridging tx */
    approvalTx!: EthTransactionResponseDto | undefined;
    /** Eth Bridging tx */
    bridgingTx!: BridgingEthTransactionResponseDto;

    [key: string]: any;

    constructor(data?: ICreateEthTransactionFullResponseDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
        ...
        if (!data) {
            this.bridgingTx = new BridgingEthTransactionResponseDto();
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.approvalTx = _data["approvalTx"] ? EthTransactionResponseDto.fromJS(_data["approvalTx"]) : undefined as any;
            this.bridgingTx = _data["bridgingTx"] ? BridgingEthTransactionResponseDto.fromJS(_data["bridgingTx"]) : new BridgingEthTransactionResponseDto();
        }
    }

    static fromJS(data: any): CreateEthTransactionFullResponseDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateEthTransactionFullResponseDto();
        result.init(data);
        return result;
    }
...
export interface ICreateEthTransactionFullResponseDto {
    /** Approval tx for the bridging tx */
    approvalTx: EthTransactionResponseDto | undefined;
    /** Eth Bridging tx */
    bridgingTx: BridgingEthTransactionResponseDto;
...
export class SolanaTransactionResponseDto implements ISolanaTransactionResponseDto {
    ...
    txRaw!: string;
    /** Block through which the tx stays valid */
...
export class BridgeTransactionFilterDto implements IBridgeTransactionFilterDto {
    ...
    originChain?: ChainEnum | undefined;
...
export class LockedTokensDto implements ILockedTokensDto {
    ...
    /** Mapping of total transferred tokens per chain */
...
export class TransferredTokensByDay implements ITransferredTokensByDay {
    /** The date of the transaction or event (YYYY-MM-DD). */
    date!: Date;
    /** Mapping of total transfered tokens per chain for day */
    totalTransferred!: { [key: string]: { [key: string]: string; }; };

    [key: string]: any;

    constructor(data?: ITransferredTokensByDay) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): TransferredTokensByDay {
        data = typeof data === 'object' ? data : {};
        let result = new TransferredTokensByDay();
        result.init(data);
        return result;
    }
...
export interface ITransferredTokensByDay {
    /** The date of the transaction or event (YYYY-MM-DD). */
    date: Date;
    /** Mapping of total transfered tokens per chain for day */
    totalTransferred: { [key: string]: { [key: string]: string; }; };
