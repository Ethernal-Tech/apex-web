...
const SOCIALS = [
  { label: "Contact Skyline", href: "/contact", icon: <Mail className="h-4 w-4" /> },
  {
    label: "Skyline on LinkedIn",
    href: "https://www.linkedin.com/company/skyline",
    icon: <Linkedin className="h-4 w-4" />,
  },
  { label: "Skyline on X", href: "https://x.com/skyline", icon: <XLogo className="h-4 w-4" /> },
];
