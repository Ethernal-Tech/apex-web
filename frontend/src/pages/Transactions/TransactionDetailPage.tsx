...
import { capitalizeWord, convertUtxoDfmToApex, formatAddress, getChainLabelAndColor } from '../../utils/generalUtils';
        ...
        <Box sx={{ px: '45px', py: '40px',fontWeight:'500' }}>
          <Box sx={{ flex: '1 1 50%', display: 'flex', flexDirection: 'column' }}>
            ...
            <Box sx={{ mb: 1, display:'flex', justifyContent: 'space-between', borderBottom:'1px solid #142E38' }}>
              ...
              <Typography variant="body1" fontSize={'16px'} sx={{ fontWeight: '500' }}>{transaction && convertUtxoDfmToApex((transaction?.amount))} APEX</Typography>
            </Box>
            <Box sx={{ mb: 1, display:'flex', justifyContent: 'space-between', borderBottom:'1px solid #142E38' }}>
