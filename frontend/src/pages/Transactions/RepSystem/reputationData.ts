...
export const repSystemMessages: readonly IRepSystemMessage[] = [
	{
		...
		subtitle:
			'Enhance your blockchain identity through daily, on-chain activity.',
	},
	{
		title: 'Your next Daily Quest might surprise you.',
		subtitle:
			'Enchance your reputation by completing quick blockchain tasks.',
	},
	{
	...
	},
	{
		...
		subtitle:
			'Compete with others and grow your standing in the ecosystem.',
	},
	{
		title: 'Got 2 minutes? Earn rewards.',
		subtitle:
			'Fast, fun tasks that help boost your blockchain credibility.',
	},
];
