  ...
  <Box className="skyline-bridge-section">
    <Box className="skyline-bridge-header">
      ...
      <Typography className="skyline-bridge-description">
        A cross-chain bridging protocol designed to transfer tokens and assets
        securely and efficiently between blockchain ecosystems.
      </Typography>
    </Box>
    <Box className="skyline-bridge-content">
      <Box className="skyline-bridge-item">
        <Box className="skyline-bridge-icon">
          <img src={InteroperabilityIcon} alt="InteroperabilityIcon" />
        </Box>
        <Box className="skyline-bridge-text">
          ...
          <Typography className="skyline-bridge-item-description">
            Connect assets, applications, and communities across multiple
            blockchains. Skyline unlocks new possibilities for cross-chain
            innovation.
          </Typography>
        </Box>
      </Box>
      <Box className="skyline-bridge-item">
        ...
        <Box className="skyline-bridge-text">
          ...
          <Typography className="skyline-bridge-item-description">
            Powered by a multi-signature validation system, Skyline ensures
            trust and protection with every transaction.
          </Typography>
        </Box>
      </Box>
      <Box className="skyline-bridge-item">
        ...
        <Box className="skyline-bridge-text">
          ...
          <Typography className="skyline-bridge-item-description">
            ...
            cost-effectiveness, enabling smooth asset transfers for any
            ecosystem.
          </Typography>
        </Box>
      </Box>
