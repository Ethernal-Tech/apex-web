...
export class TransactionControllerClient extends BaseClient {
  ...
  protected processCreateCardano(
    response: Response
  ): Promise<CreateCardanoTransactionResponseDto> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      ...
      return response.text().then((_responseText) => {
        return throwException(
          "Bad Request - Error while creating bridging transaction.",
          status,
          _responseText,
          _headers
        );
  ...
  protected processGetCardanoTxFee(
    response: Response
  ): Promise<CardanoTransactionFeeResponseDto> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      ...
      return response.text().then((_responseText) => {
        return throwException(
          "Bad Request - Error while getting bridging transaction fees.",
          status,
          _responseText,
          _headers
        );
  ...
  protected processBridgingTransactionSubmitted(
    response: Response
  ): Promise<BridgeTransactionDto> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      ...
      return response.text().then((_responseText) => {
        return throwException(
          "Bad Request - Error while confirming transaction submittion.",
          status,
          _responseText,
          _headers
        );
...
export class BridgeTransactionControllerClient extends BaseClient {
  ...
  protected processGet(response: Response): Promise<BridgeTransactionDto> {
    ...
    if (status === 200) {
      ...
      return response.text().then((_responseText) => {
        return throwException(
          "Not Found - Bridging transaction not found.",
          status,
          _responseText,
          _headers
        );
   ...
   */
  getAllFiltered(
    body: BridgeTransactionFilterDto
  ...
  protected processGetAllFiltered(
    response: Response
  ): Promise<BridgeTransactionResponseDto> {
    const status = response.status;
    let _headers: any = {};
...
export class BridgingSettingsDto implements IBridgingSettingsDto {
      ...
      if (_data["minChainFeeForBridging"]) {
        ...
        for (let key in _data["minChainFeeForBridging"]) {
          if (_data["minChainFeeForBridging"].hasOwnProperty(key))
            (<any>this.minChainFeeForBridging)![key] =
              _data["minChainFeeForBridging"][key];
        }
      }
      if (_data["minOperationFee"]) {
        ...
        for (let key in _data["minOperationFee"]) {
          if (_data["minOperationFee"].hasOwnProperty(key))
            (<any>this.minOperationFee)![key] = _data["minOperationFee"][key];
        }
      }
      if (_data["minUtxoChainValue"]) {
        ...
        for (let key in _data["minUtxoChainValue"]) {
          if (_data["minUtxoChainValue"].hasOwnProperty(key))
            (<any>this.minUtxoChainValue)![key] =
              _data["minUtxoChainValue"][key];
        }
      }
      this.minValueToBridge = _data["minValueToBridge"];
      this.maxAmountAllowedToBridge = _data["maxAmountAllowedToBridge"];
      this.maxTokenAmountAllowedToBridge =
        _data["maxTokenAmountAllowedToBridge"];
      this.maxReceiversPerBridgingRequest =
        _data["maxReceiversPerBridgingRequest"];
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (this.minChainFeeForBridging) {
      ...
      for (let key in this.minChainFeeForBridging) {
        if (this.minChainFeeForBridging.hasOwnProperty(key))
          (<any>data["minChainFeeForBridging"])[key] = (<any>(
            this.minChainFeeForBridging
          ))[key];
      }
    }
    if (this.minOperationFee) {
      ...
      for (let key in this.minOperationFee) {
        if (this.minOperationFee.hasOwnProperty(key))
          (<any>data["minOperationFee"])[key] = (<any>this.minOperationFee)[
            key
          ];
      }
    }
    if (this.minUtxoChainValue) {
      ...
      for (let key in this.minUtxoChainValue) {
        if (this.minUtxoChainValue.hasOwnProperty(key))
          (<any>data["minUtxoChainValue"])[key] = (<any>this.minUtxoChainValue)[
            key
          ];
      }
    }
    ...
    data["maxReceiversPerBridgingRequest"] =
      this.maxReceiversPerBridgingRequest;
    return data;
  }
}
      ...
      if (_data["cardanoChainsNativeTokens"]) {
        ...
        for (let key in _data["cardanoChainsNativeTokens"]) {
          if (_data["cardanoChainsNativeTokens"].hasOwnProperty(key))
            (<any>this.cardanoChainsNativeTokens)![key] = _data[
              "cardanoChainsNativeTokens"
            ][key]
              ? _data["cardanoChainsNativeTokens"][key].map((i: any) =>
                  NativeTokenDto.fromJS(i)
                )
              : [];
        }
      }
      this.bridgingSettings = _data["bridgingSettings"]
        ? BridgingSettingsDto.fromJS(_data["bridgingSettings"])
        : new BridgingSettingsDto();
      if (Array.isArray(_data["enabledChains"])) {
        this.enabledChains = [] as any;
        for (let item of _data["enabledChains"]) this.enabledChains!.push(item);
      }
    }
  }
    ...
    if (this.cardanoChainsNativeTokens) {
      ...
      for (let key in this.cardanoChainsNativeTokens) {
        if (this.cardanoChainsNativeTokens.hasOwnProperty(key))
          (<any>data["cardanoChainsNativeTokens"])[key] = (<any>(
            this.cardanoChainsNativeTokens
          ))[key];
      }
    }
    data["bridgingSettings"] = this.bridgingSettings
      ? this.bridgingSettings.toJSON()
      : <any>undefined;
    if (Array.isArray(this.enabledChains)) {
      data["enabledChains"] = [];
      for (let item of this.enabledChains) data["enabledChains"].push(item);
    }
    return data;
  }
}
...
export class CreateCardanoTransactionResponseDto
  implements ICreateCardanoTransactionResponseDto
{
...
export class CardanoTransactionFeeResponseDto
  implements ICardanoTransactionFeeResponseDto
{
...
export class CreateEthTransactionResponseDto
  implements ICreateEthTransactionResponseDto
{
  from!: string;
  to!: string;
...
export class TransactionSubmittedDto implements ITransactionSubmittedDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["receiverAddrs"])) {
        ...
        for (let item of _data["receiverAddrs"]) this.receiverAddrs!.push(item);
      }
      this.amount = _data["amount"];
      this.nativeTokenAmount = _data["nativeTokenAmount"];
      this.txRaw = _data["txRaw"];
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.receiverAddrs)) {
      data["receiverAddrs"] = [];
      for (let item of this.receiverAddrs) data["receiverAddrs"].push(item);
    }
    data["amount"] = this.amount;
    data["nativeTokenAmount"] = this.nativeTokenAmount;
    data["txRaw"] = this.txRaw;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.createdAt = _data["createdAt"]
        ...
        : <any>undefined;
      this.finishedAt = _data["finishedAt"]
        ? new Date(_data["finishedAt"].toString())
        : <any>undefined;
    }
  }
...
export class BridgeTransactionResponseDto
  implements IBridgeTransactionResponseDto
{
      ...
      if (_data["chains"]) {
        ...
        for (let key in _data["chains"]) {
          if (_data["chains"].hasOwnProperty(key))
            (<any>this.chains)![key] =
              _data["chains"][key] !== undefined ? _data["chains"][key] : {};
        }
      }
      if (_data["totalTransfered"]) {
        ...
        for (let key in _data["totalTransfered"]) {
          if (_data["totalTransfered"].hasOwnProperty(key))
            (<any>this.totalTransfered)![key] =
              _data["totalTransfered"][key] !== undefined
                ? _data["totalTransfered"][key]
                : {};
        }
      }
    }
    ...
    if (this.chains) {
      ...
      for (let key in this.chains) {
        if (this.chains.hasOwnProperty(key))
          (<any>data["chains"])[key] = (<any>this.chains)[key];
      }
    }
    if (this.totalTransfered) {
      ...
      for (let key in this.totalTransfered) {
        if (this.totalTransfered.hasOwnProperty(key))
          (<any>data["totalTransfered"])[key] = (<any>this.totalTransfered)[
            key
          ];
      }
    }
